// Fixed using valgrid:
// valgrind -s --tool=memcheck --track-origins=yes --leak-check=full ./val_test02_solved
...
//
{
  ...
  // As x = new int[10] without '()' poses valgrind issues
  // due to initialization, we can simply use the empty
  // paranthesis to allow for 0 initialization.
  x = new int[10]();
//
